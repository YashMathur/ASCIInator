...
parser.add_argument('--width', '-w', type=int, default=200, help='width of the output in characters')
parser.add_argument('--font-size', '-f', type=int, default=12, help='size of the font in px')
parser.add_argument('--font-ratio', '-r', type=float, default=1, help='ratio of the width of the font to the height of the font')
...
#print('\n')
basewidth = int((args.width/args.font_ratio))
